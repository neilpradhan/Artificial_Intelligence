...
public:
    ...
    ///comparison operator
    // const to right is a promise that I am not going to change any data variables like m_time
...
// mtime chi value ptime detay initially ptime -1 ahea nantr mtime jasa
// yeto tasa ptime baddal ta